...
def classify_triangle(side_1:float, side_2:float, side_3:float)->str:
    """Classifies a triangle into 1 of 4 categories: "does not exist", "acute", "obtuse", or "right"
        ...
        NOTE: Your implementation should not use the built-in sort or sorted functions
        ...
        "right"
    """
    #largest_side = max(side_1, side_2, side_3)
    #smallest_side= min(side_1, side_2, side_3)
    #middle_side = side_1 + side_2 + side_3 - largest_side - smallest_side
    ...
    if (side_2 >= side_3 and side_2>= side_1):
        
            largest_side= side_2  
            middle_side = side_1
            smallest_side= side_3
    if (side_3 >= side_2 and side_3>= side_1):
